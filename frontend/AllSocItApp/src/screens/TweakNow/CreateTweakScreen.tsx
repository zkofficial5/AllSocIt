...
type CreateTweakScreenProps = {
  navigation: NativeStackNavigationProp<RootStackParamList, "CreateTweak">;
  route: RouteProp<RootStackParamList, "CreateTweak">;
};

export default function CreateTweakScreen({
  navigation,
  route,
}: CreateTweakScreenProps) {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Error",
        error.response?.data?.detail || "Could not create tweak",
      );
    }
  };
    ...
    >
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {showTemplates && templates.length === 0 && (
            <Text
              style={[styles.emptyTemplates, { color: colors.textSecondary }]}
            >
